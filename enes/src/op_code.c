...
static OpCode cpu_op_codes[OP_COUNT] = {
    ...
    (OpCode){ 0x7d, "ADC", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0x79, "ADC", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0x61, "ADC", 2, 6, Indirect_X },
    (OpCode){ 0x71, "ADC", 2, 5/*+ page crossed*/, Indirect_Y },

    (OpCode){ 0xe9, "SBC", 2, 2, Immediate },
    (OpCode){ 0xe5, "SBC", 2, 3, ZeroPage },
    (OpCode){ 0xf5, "SBC", 2, 4, ZeroPage_X },
    (OpCode){ 0xed, "SBC", 3, 4, Absolute },
    (OpCode){ 0xfd, "SBC", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0xf9, "SBC", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0xe1, "SBC", 2, 6, Indirect_X },
    (OpCode){ 0xf1, "SBC", 2, 5/*+ page crossed*/, Indirect_Y },

    (OpCode){ 0x29, "AND", 2, 2, Immediate },
    (OpCode){ 0x25, "AND", 2, 3, ZeroPage },
    (OpCode){ 0x35, "AND", 2, 4, ZeroPage_X },
    (OpCode){ 0x2d, "AND", 3, 4, Absolute },
    (OpCode){ 0x3d, "AND", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0x39, "AND", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0x21, "AND", 2, 6, Indirect_X },
    (OpCode){ 0x31, "AND", 2, 5/*+ page crossed*/, Indirect_Y },

    (OpCode){ 0x49, "EOR", 2, 2, Immediate },
    (OpCode){ 0x45, "EOR", 2, 3, ZeroPage },
    (OpCode){ 0x55, "EOR", 2, 4, ZeroPage_X },
    (OpCode){ 0x4d, "EOR", 3, 4, Absolute },
    (OpCode){ 0x5d, "EOR", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0x59, "EOR", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0x41, "EOR", 2, 6, Indirect_X },
    (OpCode){ 0x51, "EOR", 2, 5/*+ page crossed*/, Indirect_Y },

    (OpCode){ 0x09, "ORA", 2, 2, Immediate },
    (OpCode){ 0x05, "ORA", 2, 3, ZeroPage },
    (OpCode){ 0x15, "ORA", 2, 4, ZeroPage_X },
    (OpCode){ 0x0d, "ORA", 3, 4, Absolute },
    (OpCode){ 0x1d, "ORA", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0x19, "ORA", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0x01, "ORA", 2, 6, Indirect_X },
    (OpCode){ 0x11, "ORA", 2, 5/*+ page crossed*/, Indirect_Y },
    ...
    (OpCode){ 0xd5, "CMP", 2, 4, ZeroPage_X },
    (OpCode){ 0xcd, "CMP", 3, 4, Absolute },
    (OpCode){ 0xdd, "CMP", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0xd9, "CMP", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0xc1, "CMP", 2, 6, Indirect_X },
    (OpCode){ 0xd1, "CMP", 2, 5/*+ page crossed*/, Indirect_Y },
    ...
    /* Branching */
    (OpCode){ 0x4c, "JMP", 3, 3, NoneAddressing }, //AddressingMode that acts as Immidia }e
    (OpCode){ 0x6c, "JMP", 3, 5, NoneAddressing }, //AddressingMode:Indirect with 6502 b }g
    ...
    (OpCode){ 0xd0, "BNE", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0x70, "BVS", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0x50, "BVC", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0x30, "BMI", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0xf0, "BEQ", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0xb0, "BCS", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0x90, "BCC", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    (OpCode){ 0x10, "BPL", 2, 2 /*(+ branch succeeds +2 if to a new page)*/, NoneAddressing },
    ...
    (OpCode){ 0xbd, "LDA", 3, 4/*+ page crossed*/, Absolute_X },
    (OpCode){ 0xb9, "LDA", 3, 4/*+ page crossed*/, Absolute_Y },
    (OpCode){ 0xa1, "LDA", 2, 6, Indirect_X },
    (OpCode){ 0xb1, "LDA", 2, 5/*+ page crossed*/, Indirect_Y },

    (OpCode){ 0xa2, "LDX", 2, 2, Immediate },
    (OpCode){ 0xa6, "LDX", 2, 3, ZeroPage },
    (OpCode){ 0xb6, "LDX", 2, 4, ZeroPage_Y },
    (OpCode){ 0xae, "LDX", 3, 4, Absolute },
    (OpCode){ 0xbe, "LDX", 3, 4/*+ page crossed*/, Absolute_Y },

    (OpCode){ 0xa0, "LDY", 2, 2, Immediate },
    (OpCode){ 0xa4, "LDY", 2, 3, ZeroPage },
    (OpCode){ 0xb4, "LDY", 2, 4, ZeroPage_X },
    (OpCode){ 0xac, "LDY", 3, 4, Absolute },
    (OpCode){ 0xbc, "LDY", 3, 4/*+ page crossed*/, Absolute_X },
    ...
    (OpCode){ 0x96, "STX", 2, 4, ZeroPage_Y },
    (OpCode){ 0x8e, "STX", 3, 4, Absolute },

    (OpCode){ 0x84, "STY", 2, 3, ZeroPage },
    (OpCode){ 0x94, "STY", 2, 4, ZeroPage_X },
...
static OpCode* op_to_index[OP_COUNT];
